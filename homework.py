...
def check_response(response):
    ...
    Возвращаемое значение:
        Список домашних работ (он может быть и пустым), доступный в ответе API по ключу 'homeworks'.
    """
    try:
...
def parse_status(homework):
    ...
    Возвращаемое значение:
        Подготовленную для отправки в Telegram строку, содержащую один из вердиктов словаря HOMEWORK_STATUSES.
    """
...
def check_tokens():
    ...
    for item in ENV_VARS:
        ...
        if env is None:
            text = (
                f'Отсутствует или неправильная обязательная переменная окружения {item}.\n'
